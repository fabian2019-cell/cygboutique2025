          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Seleccione Empleado</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                        ...
                        foreach ($fila as $key => $value) {
                            if (isset($objE)) {
                                    if ($value->getId_empleado() == $objE->getEmpleado()) {
                                       ...
                                       echo "<option value='". $value->getId_empleado() ."'>" . $value->getNombres()." "  . $value->getApellidos(). "</option>";
                                                    }
...
<?php
    ...
    if($bandera=="add"){
        ...
        $daoE=new DAOVentaproducto(); 
            ...
            msg("Sys-BOUTIQUE", "Cargando...", "success","../controlador/pdf_ventaporempleado.php?id=".$empleado,100);
