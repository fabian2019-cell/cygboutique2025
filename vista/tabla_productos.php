...
<head>
  ...
  <script language="javascript">
    ...
    function showConfirmMessage2(id) {
        swal({
            title:"Quiere reservar este articulo?",
            text: "Podra encontrarlo en Item >Productos reservados",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Si, proceder",
            ...
            document.getElementById('bandera').value='reservar';
            document.getElementById('baccion').value=id;
            document.asociaciones.submit();
        });
    }
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 270.653px;">Nombre</th>
                     ...
                     echo "<tr>";
                         ...
                         echo " <td> <div class='dropdown m-b-10'>
                                    ...
                                    <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                        ...
                                        onclick=showConfirmMessage('".$value->getId_prod()."')>Eliminar</a>
                                        <a class='dropdown-item btn_editar' data-id='' href='javascript:void(0)' 
                                        onclick= imprimir('".base64_encode($value->getId_prod())."')>Actualizar</a>
                                        <a class='dropdown-item btn_editar' data-id='' href='javascript:void(0)' 
                                        onclick= nuevo()>Nuevo</a>
                                        <a class='dropdown-item btn_eliminar' data-id='' href='javascript:void(0)'
                                        onclick=showConfirmMessage2('".$value->getId_prod()."')>Reservar</a>
                                    </div>
                                </div>";
...
<?php 
    ...
    if ($bandera=="delete") {
        ...
        if ($daoE->eliminar($baccion)==1) {
            msg("Sys-BOUTIQUE", "Registro Eliminado (- o)", "success","tabla_productos.php",1000);
            # code...
        } else {
            msg("Sys-BOUTIQUE", "Registro no eliminado (- o)", "success","tabla_productos.php",1000);
            # code...
        }

    }else if($bandera=="reservar"){
        require_once "../controlador/DAOProducto.php";
        $daoE=new DAOProducto();
        if ($daoE->actualizarReservado($baccion)==1) {
            msg("Sys-BOUTIQUE", "Articulo reservado (- o)", "success","tabla_productosr.php",1000);
            # code...
        } else {
            msg("Sys-BOUTIQUE", "Articulo no reservado :(", "success","tabla_productos.php",1000);
            # code...
        }
