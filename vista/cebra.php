   ...
   <script language="javascript">
    function validacion() {
        if (document.getElementById('producto').value === "0" ) {
            ...
            mostrarMensaje("Sys-BOUTIQUE", "Complete los campos antes de guardar", "error","reporte_emp.php",1000);
        }else{
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Seleccione el rango que desea generar.</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                    ...
                    <?php
                        ...
                        foreach ($fila as $key => $value) {
                            if (isset($objE)) {
                                       ...
                                       echo "<option value='". $value->getId_prod() ."'>" . $value->getCodigo()." "  . $value->getNombre(). "</option>";
                                                    }
            ...
            <form action="" method="post" class="form-group" id="users" name="users">
                <input type="hidden" name="bandera1" id="bandera1">
                    <input type="hidden" name="baccion1" id="baccion1" value="<?php if(isset($objE)) echo $objE->getId_prod(); ?>">
            <?php  
                  if(isset($objE)){
...
<?php
    ...
    if($bandera=="add"){
        ...
        $daoE=new DAOVentaproducto(); 
            ...
            msg("Sys-BOUTIQUE", "Cargando...", "success","muestra_cebra.html?id=".$producto,100);
