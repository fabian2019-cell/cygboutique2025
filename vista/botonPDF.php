...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
   <script language="javascript">
    ...
    function limpiar(){
        $('#codigo').val('');
        $('#nombre').val('');
        location.href="divisionBM.php.php";
    }
    function abrir(URL){
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="" method="post" class="form-group" id="asociaciones" name="asociaciones">
                ...
                <div class="card-footer" style="width: 30%; margin-left: 50%; transform: translateX(-50%);">
                  <button type="button" style="background-color:#007bff; border-color:white; color:white; width: 95%;" class="btn btn-success swalDefaultSuccess" onclick="abrir('http://localhost/asociacionesues/controlador/actapdf.php?id=<?php echo $id; ?>')">Mostrar</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<?php
    ...
    if($bandera=="add"){
        ...
        if ($daoE-> insertarDivision(new ClaseDivisionbm($codigo,$nombre))==1) {   
        ...
        require_once "../controlador/DAODivisionbm.php"; 
        $daoE=new DAODivisionbm();
       if ($daoE->actualizarDivision(new ClaseDivisionbm($baccion,$nombre))==1) {
            # code...
