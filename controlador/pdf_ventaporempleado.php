     ...
     function Header()
         {
          ...
          // $this->Image('../vista/dist/img/logo_elcarmen.jpg', 250, 10, 20, 20);
           ...
           $this->SetXY(85,34);
           $this->Cell(70,10,utf8_decode('Reporte de Ventas de '),0,0,'C');
...
//$pdf->SetFont('Times','',9);
     ...
     $fila=$daoVP->consultaVentasporempleado($id);
     $objEmp=null;
     $objEmp=$daoEmp->consultaIndividualEmpleado($id);
     $objP=null;
     $acum=0;
     $pdf->SetFont('Arial','B',10);
     $pdf->SetXY(120,34);
     $pdf->Cell(80,10,''.$objEmp->getNombres().' '.$objEmp->getApellidos(),0,0,'C');
      $pdf->Ln();
       $pdf->Ln();
    $pdf->SetFont('Times','',9);
