...
<?php include '../layouts/headerStyle.php'; ?>
    ...
    <body class="fixed-left">
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-30" id="formulario_desbloqueo1" name="formulario_desbloqueo1" >
                            ...
                            <div class="user-thumb text-center m-b-30">
                                <img src="../public/assets/images/favii.png" class="rounded-circle img-thumbnail" alt="thumbnail">
                                <h6><?php print $_SESSION['usuario'] ?></h6>
                            </div>
        ...
        <script src="funciones_ingresoLogin.js" type="text/javascript" charset="utf-8" async defer></script>
